...
// let messy = document.querySelectorAll('.mess');

// for (let i = 0; i < messy.length; i++) {
//     messy[i].addEventListener('click', function() {
//         messy[i].style.backgroundColor = randomColor();
//         messy[i].style.color = randomColor(); 
//     })
// }